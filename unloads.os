...
Процедура ОтключитьСеансыИБлокироватьИБ(ИБ, РежимРаботы) Экспорт
	...
	Если ФайловаяИБ Тогда
		// todo: создать файл 1Cv8.cdn
//{1,20151113080016,20151113110000,"Происходит выгрузка информационной базы
//
//Для администратора:
...
//ENTERPRISE /F""C:\bases\uat.tst"" /CРазрешитьРаботуПользователей /UC0003","0003",""}
